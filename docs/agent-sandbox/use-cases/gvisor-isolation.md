---
title: gVisor Isolation | Agent Sandbox
description: Harden Agent Sandbox workload isolation using gVisor, a userspace kernel that intercepts application system calls to protect the host.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/gvisor-isolation/
site: Agent Sandbox
