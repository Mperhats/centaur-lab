...
description: AI agents that interact with graphical desktops, browsers, and GUI applications inside isolated sandboxes.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/computer-use/
site: Agent Sandbox
