---
title: Protecting Agentic Sandboxes with OPA Gatekeeper | Agent Sandbox
description: This guide provides step-by-step instructions for configuring OPA Gatekeeper security policy to prevent granting permissions to ServiceAccounts used by Sandboxes.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/opa-gatekeeper/
site: Agent Sandbox
