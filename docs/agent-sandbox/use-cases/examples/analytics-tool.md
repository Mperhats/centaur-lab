---
title: AI Analytics with agent-sandbox | Agent Sandbox
description: This guide describes how to build Docker image that defines analytics tool for an ADK agent, push the Docker image to a Artifact Registry repository and deploy the pushed image.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/analytics-tool/
site: Agent Sandbox
...
* Agent-sandbox installed on GKE. Here is the ([Installation Guide](/docs/use-cases/getting_started/))
