...
description: This example implements a Python server in a sandbox container that can run the computer-use-preview agent.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/gemini-cu-sandbox/
site: Agent Sandbox
