...
description: This example demonstrates how to compose a Sandbox with NetworkPolicy, Ingress and Service using KRO (Kubernetes Resource Orchestrator).
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/composing-sandbox-nw-policies/
site: Agent Sandbox
