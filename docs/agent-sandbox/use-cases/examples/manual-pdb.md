---
title: Manual PodDisruptionBudget (PDB) Configuration | Agent Sandbox
description: This guide demonstrates how to protect Sandboxes from voluntary disruptions (e.g., node drains, cluster upgrades) using standard Kubernetes PodDisruptionBudget manifests, without relying on the controller's automated disruption control.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/manual-pdb/
site: Agent Sandbox
