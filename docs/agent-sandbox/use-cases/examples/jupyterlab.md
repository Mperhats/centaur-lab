---
title: JupyterLab on Agent-Sandbox | Agent Sandbox
description: Deploy single-user JupyterLab environments using Kubernetes agent-sandbox.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/jupyterlab/
site: Agent Sandbox
...
**[Agent-Sandbox Installation Guide](/docs/getting_started/overview/)**
