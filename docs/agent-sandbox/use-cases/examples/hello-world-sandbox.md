---
title: Hello World on Kubernetes Sandbox | Agent Sandbox
description: A simple Hello World sandbox example that demonstrates building a Docker image, pushing to Artifact Registry, and deploying to Kubernetes.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/hello-world-sandbox/
site: Agent Sandbox
...
**1. Build and Run the Docker Image** Open a terminal in the directory containing the Dockerfile.
...
**4. Deploy to Kubernetes** Ensure your kubectl context is pointing to the correct cluster. Apply the manifest:
