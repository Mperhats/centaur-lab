---
title: OpenClaw Sandbox Example | Agent Sandbox
description: This example demonstrates how to run OpenClaw (formerly Moltbot) inside the Agent Sandbox.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/openclaw-sandbox/
site: Agent Sandbox
