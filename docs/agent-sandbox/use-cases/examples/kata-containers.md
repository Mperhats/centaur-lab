---
title: Kata Containers | Agent Sandbox
description: This guide shows how to run [Agent Sandbox](https://github.com/kubernetes-sigs/agent-sandbox) with the [Kata Containers](https://katacontainers.io/) runtime using minikube as a cluster.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/kata-containers/
site: Agent Sandbox
...
From the [./scripts](/docs/use-cases/examples/kata-containers/scripts/) directory, execute the following.
