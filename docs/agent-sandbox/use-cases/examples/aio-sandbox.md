---
title: All-in-One (AIO) Sandbox Example | Agent Sandbox
description: This guide demonstrates how to create and access an All-in-One (AIO) Sandbox via Agent-Sandbox, featuring multiple pre-installed tools including VNC, VSCode, Jupyter, and Terminal in one unified environment.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/examples/aio-sandbox/
site: Agent Sandbox
...
Setup GATEWAY\_URL environment variable:
