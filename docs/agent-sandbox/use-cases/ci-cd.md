---
title: CI/CD | Agent Sandbox
description: Infrastructure patterns for using Agent Sandbox in CI/CD pipelines — network control, disruption protection, and programmatic lifecycle management.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/ci-cd/
site: Agent Sandbox
