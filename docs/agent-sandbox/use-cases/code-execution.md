---
title: Code Execution | Agent Sandbox
description: Run untrusted code in fully isolated sandboxes. Ideal for code interpreters, analytics tools, and on-demand computation.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/code-execution/
site: Agent Sandbox
