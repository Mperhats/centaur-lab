---
title: Kata Containers Isolation | Agent Sandbox
description: Harden Agent Sandbox workload isolation using Kata Containers, providing hardware virtualization with a dedicated kernel per sandbox.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/kata-containers-isolation/
site: Agent Sandbox
...
* The [Agent Sandbox Controller](/docs/getting_started/overview/) installed on your cluster.
