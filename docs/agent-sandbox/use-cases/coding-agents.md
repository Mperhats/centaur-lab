---
title: Coding Agents | Agent Sandbox
description: Autonomous agents that generate, execute, and self-correct code inside secure sandboxes with persistent storage and iterative workflows.
url: https://agent-sandbox.sigs.k8s.io/docs/use-cases/coding-agents/
site: Agent Sandbox
