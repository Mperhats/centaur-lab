---
title: Agent Sandbox Installation | Agent Sandbox
description: This guide shows how install Agent Sandbox resources in [Kubernetes in Docker (KinD)](https://kind.sigs.k8s.io/) and in [GKE](https://cloud.google.com/kubernetes-engine).
url: https://agent-sandbox.sigs.k8s.io/docs/getting_started/install_prerequisites/
site: Agent Sandbox
...
Last modified April 23, 2026: [Docs create sandbox in kind (#650) (c00c606)](https://github.com/kubernetes-sigs/agent-sandbox/commit/c00c606c640d40533f139808847a784e6306ec58)
