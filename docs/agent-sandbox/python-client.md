...
---
title: Python Client | Agent Sandbox
description: This section describes how to use the Python Client
url: https://agent-sandbox.sigs.k8s.io/docs/python-client/
site: Agent Sandbox
...
1. **Build and Push the Router Image:**
   ...
   For both Gateway Mode and Tunnel Mode, follow the instructions in [sandbox-router](https://github.com/kubernetes-sigs/agent-sandbox/blob/main/clients/python/agentic-sandbox-client/README.md) to build, push, and apply the router image and resources.

2. **Create a Sandbox Template:**

   Ensure a `SandboxTemplate` exists in your target namespace. The [test\_client.py](https://github.com/kubernetes-sigs/agent-sandbox/blob/main/clients/python/agentic-sandbox-client/test_client.py) uses the [python-runtime-sandbox](/docs/runtime-templates/python/) image.
...
2. **Install Agent Sandbox Client**
   ...
   * **Option 1: Install from PyPI (Recommended):**
     ...
     If you are using [tracing with GCP](https://github.com/kubernetes-sigs/agent-sandbox/blob/main/clients/python/agentic-sandbox-client/GCP.md#tracing-with-open-telemetry-and-google-cloud-trace), install with the optional tracing dependencies:
...
| command                                                                               | description               |
|---------------------------------------------------------------------------------------|---------------------------|
| curl.md https://agent-sandbox.sigs.k8s.io/docs/python-client/ --objective <objective> | focus on a specific topic |
