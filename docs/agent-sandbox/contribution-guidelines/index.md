---
title: Contribution Guidelines | Agent Sandbox
description: How to contribute to Agent Sandbox
url: https://agent-sandbox.sigs.k8s.io/docs/contribution-guidelines/
site: Agent Sandbox
...
Welcome to Kubernetes. We are excited about the prospect of you joining our [community](https://git.k8s.io/community)! The Kubernetes community abides by the CNCF [code of conduct](https://github.com/kubernetes-sigs/agent-sandbox/blob/main/code-of-conduct.md). Here is an excerpt:
...
* **AI-Assisted Code Reviews:** We use GitHub Copilot to provide automated, first-pass code reviews to help identify low-hanging fruit and improve review velocity.
  ...
  * **AI Agent Skills:** We provide instructions for AI agents in the [`.agents/skills/`](/docs/contribution-guidelines/.agents/skills/) directory. These skills guide AI assistants to follow project conventions and rules. Contributors using AI tools are encouraged to reference these skills.
...
[Running and debugging tests](/docs/contribution-guidelines/testing/)
