---
title: List Files and Directories | Agent Sandbox
description: List directory contents and check if paths exist in the sandbox filesystem.
url: https://agent-sandbox.sigs.k8s.io/docs/filesystem/list-files/
site: Agent Sandbox
