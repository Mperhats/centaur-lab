---
title: Upload and Download | Agent Sandbox
description: Transfer files between your local machine and the sandbox filesystem.
url: https://agent-sandbox.sigs.k8s.io/docs/filesystem/upload-download/
site: Agent Sandbox
