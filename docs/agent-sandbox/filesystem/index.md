---
title: Filesystem | Agent Sandbox
description: Read, write, list, and transfer files inside sandboxes using the Python SDK.
url: https://agent-sandbox.sigs.k8s.io/docs/filesystem/
site: Agent Sandbox
...
[Read file contents from and write files to the sandbox filesystem using the Python SDK.](/docs/filesystem/read-write/)

[List Files and Directories](/docs/filesystem/list-files/)

[List directory contents and check if paths exist in the sandbox filesystem.](/docs/filesystem/list-files/)

[Upload and Download](/docs/filesystem/upload-download/)

[Transfer files between your local machine and the sandbox filesystem.](/docs/filesystem/upload-download/)
