---
title: FUSE CSI | Agent Sandbox
description: Use Volumes with `Agent Sandbox` and with `FUSE CSI`.
url: https://agent-sandbox.sigs.k8s.io/docs/volumes/gcsfuse-csi/
site: Agent Sandbox
...
* A running GKE cluster with the [Agent Sandbox controller](/docs/getting_started/overview/) installed.
