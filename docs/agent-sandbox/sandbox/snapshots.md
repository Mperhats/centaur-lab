---
title: Snapshots | Agent Sandbox
description: Create a Sandbox and optimize the GKE cluster resource usage without losing the session data in your Sandbox.
url: https://agent-sandbox.sigs.k8s.io/docs/sandbox/snapshots/
site: Agent Sandbox
