---
title: Custom Environment | Agent Sandbox
description: Create a Sandbox with custom environment variables.
url: https://agent-sandbox.sigs.k8s.io/docs/sandbox/custom_sandbox/custom_environment/
site: Agent Sandbox
...
* A `SandboxTemplate` named `python-sandbox-template` applied to your cluster, configured to use your custom FastAPI server as its entrypoint. See the [Python Runtime Sandbox](/docs/runtime-templates/python/) guide for setup instructions.
