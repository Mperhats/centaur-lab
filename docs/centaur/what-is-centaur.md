...
url: https://centaur.run/what-is-centaur
site: Centaur
generator: Waku
---
...
![Centaur deployment layout — paradigmxyz/centaur kernel wrapped by an org-level userspace repo and a per-app application repo](/brand/containers.svg)
