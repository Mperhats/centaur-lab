---
title: Changelog - semanticscholar
url: https://semanticscholar.readthedocs.io/en/latest/changes.html
site: semanticscholar.readthedocs.io
---

Back to top

[View this page](/en/latest/_sources/changes.rst.txt "View this page")
...
## [Unreleased](https://github.com/danielnsilva/semanticscholar/compare/v0.12.0...HEAD)

## [0.12.0](https://github.com/danielnsilva/semanticscholar/compare/v0.11.0...v0.12.0) - 2026-03-29

### New Features

* Added support for Snippet Search API. ([7cbdcd5](https://github.com/danielnsilva/semanticscholar/commit/7cbdcd5))

### Enhancements

* Replaced `nest_asyncio` with thread-based async helper for Python 3.14 compatibility by [@lior-airis](https://github.com/lior-airis) in [#116](https://github.com/danielnsilva/semanticscholar/pull/116)

* Switched retry strategy from fixed 30s wait to exponential back-off by [@dbosk](https://github.com/dbosk) in [#108](https://github.com/danielnsilva/semanticscholar/pull/108)

### Bug Fixes

* Fixed false “IDs not found” warning for DOI-prefixed lookups by [@lior-airis](https://github.com/lior-airis) in [#117](https://github.com/danielnsilva/semanticscholar/pull/117)

## [0.11.0](https://github.com/danielnsilva/semanticscholar/compare/v0.10.0...v0.11.0) - 2025-09-13

### New Features

* Added support for Datasets API by [@OFSkean](https://github.com/OFSkean) in [#112](https://github.com/danielnsilva/semanticscholar/pull/112)

### Bug Fixes

* Fixed [#111](https://github.com/danielnsilva/semanticscholar/issues/111): error with null references for get\_papers. ([12f4a12](https://github.com/danielnsilva/semanticscholar/commit/12f4a12))

* Fixed debug logging. ([933a21b](https://github.com/danielnsilva/semanticscholar/commit/933a21b))

## [0.10.0](https://github.com/danielnsilva/semanticscholar/compare/v0.9.0...v0.10.0) - 2025-02-16

### New Features

* Added support for suggest paper query completions by [@david-rohrschneider](https://github.com/david-rohrschneider) in [#100](https://github.com/danielnsilva/semanticscholar/pull/100)
...
* Fixed issue with quotes in the query string by [@k1000dai](https://github.com/k1000dai) in [#99](https://github.com/danielnsilva/semanticscholar/pull/99)

## [0.9.0](https://github.com/danielnsilva/semanticscholar/compare/v0.8.4...v0.9.0) - 2024-11-30
...
## [0.8.4](https://github.com/danielnsilva/semanticscholar/compare/v0.8.2...v0.8.4) - 2024-07-08
...
## [0.8.2](https://github.com/danielnsilva/semanticscholar/compare/v0.8.1...v0.8.2) - 2024-05-31
...
## [0.8.1](https://github.com/danielnsilva/semanticscholar/compare/v0.8.0...v0.8.1) - 2024-05-17
...
## [0.8.0](https://github.com/danielnsilva/semanticscholar/compare/v0.7.0...v0.8.0) - 2024-03-15
...
## [0.7.0](https://github.com/danielnsilva/semanticscholar/compare/v0.6.0...v0.7.0) - 2023-12-29

### New Features

* Debug mode ([fb249e9](https://github.com/danielnsilva/semanticscholar/commit/fb249e9))

* Added new query parameters to search\_paper():

  * publication\_date\_or\_year ([ed4cf6f](https://github.com/danielnsilva/semanticscholar/commit/ed4cf6f))

  * min\_citation\_count ([ab1cc67](https://github.com/danielnsilva/semanticscholar/commit/ab1cc67))
...
## [0.6.0](https://github.com/danielnsilva/semanticscholar/compare/v0.5.0...v0.6.0) - 2023-11-26
...
* Added `pool_from` parameter in `get_recommended_papers()` ([d245515](https://github.com/danielnsilva/semanticscholar/commit/d245515))

### Bug Fixes

* Fixed the maximum sum of offset and limit from 10,000 to 1,000 ([908838a](https://github.com/danielnsilva/semanticscholar/commit/908838a))

### Breaking Changes

* Removed deprecated URL `partner.semanticscholar.org` ([01c9988](https://github.com/danielnsilva/semanticscholar/commit/01c9988))

* Replaced [requests](https://requests.readthedocs.io/en/latest/) with [httpx](https://www.python-httpx.org/) for asynchronous support

## [0.5.0](https://github.com/danielnsilva/semanticscholar/compare/v0.4.1...v0.5.0) - 2023-08-11
...
## [0.4.1](https://github.com/danielnsilva/semanticscholar/compare/v0.4.0...v0.4.1) - 2023-04-01
...
## [0.4.0](https://github.com/danielnsilva/semanticscholar/compare/v0.3.2...v0.4.0) - 2023-01-23
...
## [0.3.2](https://github.com/danielnsilva/semanticscholar/compare/v0.3.1...v0.3.2) - 2022-12-25

### Bug Fixes

* Fixed duplicated items issue on traversing results ([211bc5d](https://github.com/danielnsilva/semanticscholar/commit/211bc5d))

## [0.3.1](https://github.com/danielnsilva/semanticscholar/compare/v0.3.0...v0.3.1) - 2022-11-25
...
## [0.3.0](https://github.com/danielnsilva/semanticscholar/compare/v0.2.1...v0.3.0) - 2022-09-18
...
## [0.2.1](https://github.com/danielnsilva/semanticscholar/compare/v0.2.0...v0.2.1) - 2021-11-02

### Bug Fixes

* Fixed API URL definition issue ([eee1df9](https://github.com/danielnsilva/semanticscholar/commit/eee1df9))

## [0.2.0](https://github.com/danielnsilva/semanticscholar/compare/v0.1.6...v0.2.0) - 2021-10-31
...
## [0.1.6](https://github.com/danielnsilva/semanticscholar/compare/v0.1.5...v0.1.6) - 2021-09-11
...
## [0.1.5](https://github.com/danielnsilva/semanticscholar/compare/v0.1.4...v0.1.5) - 2020-08-18

### Enhancements

* Fixed API http type by [@wyh](https://github.com/wyh) in [#6](https://github.com/danielnsilva/semanticscholar/pull/6)

## [0.1.4](https://github.com/danielnsilva/semanticscholar/compare/v0.1.3...v0.1.4) - 2020-03-04
...
## [0.1.3](https://github.com/danielnsilva/semanticscholar/releases/tag/v0.1.3) - 2019-08-02
...
| command                                                                                       | description               |
|-----------------------------------------------------------------------------------------------|---------------------------|
| curl.md https://semanticscholar.readthedocs.io/en/latest/changes.html --objective <objective> | focus on a specific topic |
