...
Lives under ``centaur_lab/`` (named to avoid colliding with upstream's
reserved ``shared.tools_runtime`` namespace) so both ``workflows/`` and
``tools/`` can import these helpers without sys.path gymnastics or
cross-package back-references.
