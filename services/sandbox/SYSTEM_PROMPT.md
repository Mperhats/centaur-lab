...
After `call bfts_runner start_research`, **do not post any chat text** in the
agent stream. The workflow delivers the literature brief, research idea, and
BFTS progress to this thread automatically.
