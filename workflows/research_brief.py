...
``tools/semantic_scholar/client.py``. This workflow handler exists only
to satisfy ``call workflow run`` callers (external posters to
``/workflows/runs``); it delegates to the
