...
21-test unit suite under ``tools/semantic_scholar/tests/``. These tests
only verify the wrapper's three responsibilities:
...
from workflows.tests._mocks import MockContext, MockPool
